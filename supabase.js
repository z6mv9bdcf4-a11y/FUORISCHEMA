...
if (currentPath.endsWith("/fsocial.html")) {
    ...
    import("./fsocial-launch-visual-fixes.js").catch((error) => console.error("FSocial launch visual fixes failed to load", error));
}
...
if (currentPath.endsWith("/battle.html")) {
    ...
    import("./fsocial-surgical-final.js").catch((error) => console.error("FSocial final Battle layer failed to load", error));
}
